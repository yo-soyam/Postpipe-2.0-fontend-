                ...
                {!result?.success ? (
                    ...
                    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-8 space-y-6 shadow-2xl animate-in zoom-in-95 duration-300">
                        ...
                        <div className="pt-6 border-t border-neutral-800">
                            <h4 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">Or Deploy Instantly</h4>
                            <div className="flex flex-col gap-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <a
                                        ...
                                        className="group flex items-center justify-center gap-2 bg-black border border-neutral-800 hover:border-neutral-600 rounded-md p-3 transition-all"
                                    >
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="group flex items-center justify-center gap-2 bg-black border border-neutral-800 hover:border-blue-900/50 rounded-md p-3 transition-all"
                                    >
                                ...
                                <p className="text-xs text-neutral-500 text-center">
                                    Use <strong>{result.connectorId}</strong> and the secret above during deployment.
                                </p>
                            </div>
                        </div>
                    </div>

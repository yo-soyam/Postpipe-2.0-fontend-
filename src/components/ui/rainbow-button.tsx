...
export function RainbowButton({
  ...
  return (
    <button
      className={cn(
        "group relative inline-flex h-11 w-full animate-rainbow cursor-pointer items-center justify-center border-0 bg-[length:200%] px-8 py-2 font-medium text-primary-foreground transition-colors [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
